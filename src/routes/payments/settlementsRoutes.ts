...
router.post(
  '/:code/closures/:period/settlements/:settlementId/receipts',
  validateBody(receiptIntentSchema),
  createIntent,
);
router.post(
  '/:code/closures/:period/settlements/:settlementId/receipts/:receiptId/complete',
  completeUpload,
);
router.post('/:code/closures/:period/settlements/:settlementId/confirm', confirmReceivedHandler);
router.post(
  '/:code/closures/:period/settlements/:settlementId/waive',
  validateBody(waiveSettlementSchema),
  waive,
);
